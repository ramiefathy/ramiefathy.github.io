            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        children: [
                            { id: 'tnfi', name: 'TNF-α inhibitors', tooltip: { title: 'TNF-α Inhibitors', content: 'Examples: Adalimumab, Etanercept, Infliximab, Certolizumab. Effective for skin and joints.' } },
                            { id: 'il17i', name: 'IL-17 inhibitors', tooltip: { title: 'IL-17 Inhibitors', content: 'Examples: Secukinumab, Ixekizumab, Brodalumab. Highly effective for skin clearance.' } },
                            { id: 'il23i', name: 'IL-23 inhibitors', tooltip: { title: 'IL-23 Inhibitors', content: 'Examples: Guselkumab, Risankizumab, Tildrakizumab. Durable efficacy with infrequent dosing.' } },
                            { id: 'il1223i', name: 'IL-12/23 inhibitors', tooltip: { title: 'IL-12/23 Inhibitors', content: 'Ustekinumab. Targets the p40 subunit shared by IL-12 and IL-23.' } }
                        ]
                    },
                    {
                        id: 'jak_sys_modality',
                        ...
                        children: [
                            { id: 'jak_inhib', name: 'JAK inhibitors', tooltip: { title: 'JAK Inhibitors', content: 'Examples: Tofacitinib, Upadacitinib. Effective for PsA.' } },
                            { id: 'tyk2_inhib', name: 'TYK2 inhibitors', tooltip: { title: 'TYK2 Inhibitors', content: 'Deucravacitinib. Selective TYK2 inhibitor for psoriasis.' } }
                        ]
                    }
                ]
            }
                        ...
                        children: [
                            ...
                            },
                            {
                                ...
                                tooltip: {
                                    ...
                                    content: 'Still important options.<ul><li><strong>Methotrexate:</strong> A cost-effective choice for skin and joints.</li><li><strong>Apremilast:</strong> Oral option with a favorable safety profile (no lab monitoring).</li><li><strong>Deucravacitinib:</strong> A newer oral selective TYK2 inhibitor with efficacy comparable to some biologics.</li></ul>'
                                }
                            }
                        ]
                    }
