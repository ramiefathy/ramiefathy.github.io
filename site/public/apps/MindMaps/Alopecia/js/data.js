        ...
        "children": [
            ...
            "children": [
              {
                ...
                "tooltip": {
                  ...
                  "content": "<p>Loss of follicular openings supports established cicatricial alopecia. Visible ostia do not exclude early inflammatory scarring disease; correlate symptoms, perifollicular changes, trichoscopy, and biopsy when indicated.</p>\n"
                }
              },
              {
                "id": "inflam_signs",
          ...
          },
          {
            ...
            "tooltip": {
              ...
              "content": "<p>Gently pull a small bundle of hairs and document site, technique, and number removed. The historical &gt;10% cutoff is not universal: a study of 181 healthy participants found 97.2% had two or fewer hairs removed. An increased result supports active shedding but does not identify its cause.</p>\n"
            }
          },
          {
            "id": "assoc_signs",
        ...
        "children": [
          ...
          },
          {
            ...
            "tooltip": {
              ...
              "content": "<ul>\n<li><strong>Traction Alopecia:</strong> Hair loss from prolonged or repetitive tension on the hair follicle. Can become scarring if chronic.</li>\n<li><strong>Trichotillomania:</strong> A hair-pulling disorder classified with obsessive-compulsive and related disorders; assess behavior, distress, and alternative causes.</li>\n</ul>\n"
            }
          }
        ]
      },
    ...
    "children": [
        ...
        "children": [
          {
            ...
            "tooltip": {
              ...
              "content": "<p>Topical minoxidil is an established option; strength and application schedule depend on the product and population. Low-dose oral minoxidil is off-label for alopecia and requires individualized cardiovascular, renal, pregnancy, and interaction assessment. In a 24-week randomized trial in men, oral 5 mg daily did not demonstrate superiority over topical 5% twice daily for the primary hair-density outcomes.</p>\n"
            }
          },
          {
            "id": "5ari_aga",
      ...
      },
      {
        ...
        "tooltip": {
          ...
          "content": "<p>Hair transplantation redistributes donor follicles in selected candidates. It is not the only possible route to visible regrowth where viable miniaturized follicles remain; medical treatment and realistic donor-area assessment remain important.</p>\n"
        },
        "children": [
          {
            "id": "tx_aga",
    ...
    "children": [
      {
        ...
        "tooltip": {
          "title": "Localized alopecia areata",
          "content": "<p>Localized treatment can suit patchy disease. Extent, activity, eyebrow/eyelash involvement, age, distress, and preference matter; &lt;50% scalp loss is not uniformly mild.</p>\n"
        },
        "children": [
          {
            "id": "il_steroids_aa",
      ...
      },
      {
        ...
        "tooltip": {
          ...
          "content": "<p>Consider systemic treatment for appropriately selected severe or otherwise high-impact AA after individualized discussion; extent alone does not mandate treatment.</p>\n"
        },
        "children": [
          {
            "id": "jaki_aa",
            ...
            "tooltip": {
              ...
              "content": "<p>Oral JAK inhibitors are targeted small molecules, not biologics. U.S. severe-AA indications include baricitinib and deuruxolitinib in adults, and ritlecitinib from age 12. Product-specific screening, contraindications, reproductive counseling, and boxed warnings apply. Tofacitinib and oral ruxolitinib use for AA is off-label; efficacy is not established equally across agents.</p>\n"
            }
          },
          {
            "id": "contact_immuno",
